...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Future value after " + years + " years (Recursive): ₹" + df.format(valueRecursive));

        double valueMemoized = ForecastRecursive.futureValueMemoized(presentValue, annualGrowthRate, years);
        System.out.println("Future value after " + years + " years (Memoized): ₹" + df.format(valueMemoized));
